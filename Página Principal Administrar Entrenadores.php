    ...
    <head>
        ...
        <script>
            function searchTable() {
                ...
                const table = document.getElementById("entrenadores");
    ...
    <body>
        ...
        <section class="jumbotron d-flex justify-content-center align-items-center" style="height: 100vh;">
            ...
            <div class="container mt-5">
                ...
                <div class="mb-4 row">
                    <div class="col-md-3">
                        <select id="filterColumn" class="form-select mb-2">    
                            ...
                            <?php
                            $columnas = Columnas_Tabla($conn, "entrenador");
                ...
                <table id="entrenadores" class="table table-striped table-dark">
                    <thead>
                        <tr>
                            <?php
                            $columnas = Columnas_Tabla($conn, "entrenador");
                        ...
                        <tbody>
                            ...
                            if ($entrenadores) {
                                foreach ($entrenadores as $entrenador) {
                                    // Formatear el RUT para que contenga punto y guion
                                    $rut = $entrenador["Rut_entrenador"];
                                    $formatear_rut = formatearRUT($rut);
                                    echo "<tr>";   
                                    echo "<td style='text-align: center;'>".$formatear_rut."</td>";       
                                    echo "<td style='text-align: center;'>".$entrenador["Nombre_entrenador"]."</td>";   
                                    echo "<td style='text-align: center;'>".$entrenador["Apellido_entrenador"]."</td>";   
                                    echo "<td style='text-align: center;'>".$entrenador["Correo_entrenador"]."</td>";   
                                    echo "<td style='text-align: center;'>".$entrenador["Fono_entrenador"]."</td>";   
                                    ...
                                    echo "<td style='text-align: center;'>
                                        <a href='editar/Editar Entrenador.php?id=". $entrenador["Rut_entrenador"] ."' class='btn btn-primary btn-sm'>Editar</a>
                                        <a href='eliminar/Eliminar Entrenador.php?id=". $entrenador["Rut_entrenador"] ."' class='btn btn-danger btn-sm'
                                        onclick='return confirm(\"¿Estás seguro de eliminar este registro?\");'>Eliminar</a>
                                        </td>";   
                                    echo "</tr>";   
                                }
                            } else {
                                echo "<tr><td colspan='10'>No hay Entrenadores registrados</td></tr>";
                            }
                ...
                <form>
                    <a href="pdf/PDF Entrenadores.php" class="btn btn-secondary">Exportar Tabla Completa a PDF</a>
                    <a href="agregar/Agregar Entrenador.php" class="btn btn-primary">Agregar Entrenador</a>
                </form>
            </div>
